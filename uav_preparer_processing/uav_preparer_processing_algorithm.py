...
/***************************************************************************
 UAVPreparerProcessing
                                 A QGIS plugin
 This plugin examines height properties on a DSA
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2021-05-06
        copyright            : (C) 2021 by Sassa
        email                : tzu.tung.chen@gu.se
 ***************************************************************************/
...
class UAVPreparerProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        """
        # InputParameters
        vlayer = self.parameterAsVectorLayer(parameters, self.INOUT_POINT, context)
        ...
        for f in vlayer.getFeatures():
            # stop the algoriths if cancel button has beem clicked
            ...
            bigraster = gdal.Open(filepath.dsm)
            gdal.Translate(self.plugin_dir + '/clipdsm.tif', bigraster, projWin=bbox)
            bigraster = None
            Dataset = gdal.Open(self.plugin_dir + '/climdsm.tif')
